...
description: How to run Backstage and PostgreSQL with Docker Compose
---

## Summary

This page describes how to run a Backstage backend image together with a
...
[deployment overview](index.md), [Docker image guide](docker.md), and
[database guide](../getting-started/config/database.md).

## Prerequisites

Complete the prerequisites in [Building a Docker image](docker.md#prerequisites)
...
The credentials in this example are for local development and proofs of concept.
Use secret management and stronger credentials for any shared or production
environment.
